...
import { FaRegCircleCheck, FaRegCircleXmark, FaRegClock, FaMemory, FaRegFileExcel } from 'react-icons/fa6';
...
export default function SubmissionResultIcon({ resultId, submissionResults }: SubmissionResultIconProps) {
